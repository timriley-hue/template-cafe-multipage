...
export default function PrivacyPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="prose text-gray-700 space-y-5 leading-relaxed">
        <p>This website is operated by {site.name}. We take your privacy seriously and only collect information that is necessary to run the business.</p>
